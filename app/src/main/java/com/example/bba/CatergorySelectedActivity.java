...
public class CatergorySelectedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catergory_selected);
        ...
        userAdapter = new UserAdapter(CatergorySelectedActivity.this, userList);
