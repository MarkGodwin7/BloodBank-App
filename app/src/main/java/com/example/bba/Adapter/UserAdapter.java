package com.example.bba.Adapter;
...
import com.example.bba.Email.JavaMailApi;
import com.example.bba.Models.User;
import com.example.bba.R;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UserAdapter.ViewHolder holder, int position) {
        ...
        Glide.with(context).load(user.getProfilepictureur1()).into(holder.userProfileImage);
